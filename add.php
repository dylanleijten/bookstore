...
if(is_numeric($_POST['productnummer'])) {
    ...
    echo("Productnummer is niet numeriek</br> Wrong Product Number");
    echo "<p><a href=\"javascript:history.back()\">Pagina terug!!<br>Go back!!</a></p>\n";
    exit();
}
...
if(is_numeric($_POST['hoeveelheid'])) {
    ...
    echo("Hoeveelheid is niet numeriek!!<br> Amount must be a number!!");
    echo "<p><a href=\"javascript:history.back()\">Pagina terug!!<br>Go back!!</a></p>\n";
    exit();
}
